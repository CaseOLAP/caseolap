...
if __name__ == '__main__':
    ...
    download_pubmed(DATA_DIR,download_config,ftp_config,logFilePath)
    
    ''' 
    verify download -----------------
    '''
    
    check_all_md5_in_dir(BASELINE_DIR,logFilePath)
    check_all_md5_in_dir(UPDATE_FILES_DIR,logFilePath)
    
    '''
    Extract downloaded files --------------
    '''
    
    extract_all_gz_in_dir(BASELINE_DIR,logFilePath)
    extract_all_gz_in_dir(UPDATE_FILES_DIR,logFilePath)
